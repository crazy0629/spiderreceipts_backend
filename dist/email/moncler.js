...
exports.monclerEmail = void 0;
const monclerEmail = (form) => {
    return `<!DOCTYPE html>
<html lang="en">
...
Order
number
<br>${form === null || form === void 0 ? void 0 : form.order_number}
</p>
</td>
</tr>
<tr>
...
<p
style="margin:0;padding:0;color:#000000;font-family:'Futuraefoplight8-regular',Helvetica,Arial,sans-serif;font-size:16px;font-weight:300;line-height:20px;letter-spacing:.03em;text-align:left;margin-bottom:4px">
${form === null || form === void 0 ? void 0 : form.payment_method}
</p>
</td>
</tr>
<tr>
...
exports.monclerEmail = monclerEmail;
