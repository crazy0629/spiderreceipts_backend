...
exports.diorEmail = void 0;
const diorEmail = (form) => {
    return `<!DOCTYPE html>
  <html lang="en">
                                                                                                                                                          ...
                                                                                                                                                          <td>
                                                                                                                                                              <p
                                                                                                                                                                  ...
                                                                                                                                                                  <span
                                                                                                                                                                      ...
                                                                                                                                                                      order
                                                                                                                                                                      number
                                                                                                                                                                      ${form === null || form === void 0 ? void 0 : form.order_number}</span><wbr>, placed on ${form === null || form === void 0 ? void 0 : form.order_date}<wbr>. It will be prepared with the greatest care and we will notify you by email as soon as it is dispatched.
                                                                                                                                                              </p>
                                                                                                                                                          </td>
                                                                                                                                                      </tr>
                                                                                                                                                  </tbody>
                                                                                                                                      ...
                                                                                                                                      <tr>
                                                                                                                                          <td
                                                                                                                                              ...
                                                                                                                                              <p
                                                                                                                                                  style="margin:0px;padding:0px;text-align:center;font-size:15px;color:#000000;font-family:'Century Gothic',CenturyGothic,AppleGothic,sans-serif;line-height:25px">
                                                                                                                                                  <strong
                                                                                                                                                      style="text-transform:uppercase">${form === null || form === void 0 ? void 0 : form.full_name}</strong>
