...
exports.stadiumEmail = void 0;
const stadiumEmail = (form) => {
    return `<!DOCTYPE html>
<html lang="en">
...
order</span>
<span
style="font-family:Helvetica,Arial,sans-serif;text-align:left;margin:0;font-size:24px;line-height:1.35;font-weight:600;color:#a41d23">${form === null || form === void 0 ? void 0 : form.order_number}</span>
</th>
<th style="vertical-align:top;color:#656565;font-family:Helvetica,Arial,sans-serif;line-height:22px;text-align:left;font-size:16px;margin:0;font-weight:normal;width:0;padding:0"
align="left"
valign="top">
...
${form === null || form === void 0 ? void 0 : form.discount}
</p>
</th>
</tr>
</tbody>
...
exports.stadiumEmail = stadiumEmail;
