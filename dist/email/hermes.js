...
exports.hermesEmail = void 0;
const hermesEmail = (form) => {
    return `<!DOCTYPE html>
<html lang="en">
...
bgcolor="#ffffff">
<span
style="font-family:Georgia;font-size:15.0px;line-height:17.0px;color:#626262">${form === null || form === void 0 ? void 0 : form.order_date}</span>
</td>
</tr>
</tbody>
</table>
...
target="_blank"
data-saferedirecturl="https://www.google.com/url?q=https://www.hermes.com/nl/en//%23tray-find-order&amp;source=gmail&amp;ust=1692883797779000&amp;usg=AOvVaw2ta6ptUV8ngZfodPjI6ApF">#${form === null || form === void 0 ? void 0 : form.order_number}</a>
</span>
</td>
</tr>
</tbody>
...
bgcolor="#ffffff">
<span
style="font-family:Georgia;font-size:15px;line-height:17px;color:#626262">${form === null || form === void 0 ? void 0 : form.item}</span>
</td>
...
<br>Ref:
${form === null || form === void 0 ? void 0 : form.reference_number}
<br>Qty: 1
<br>
<br>
</span>
...
bgcolor="#ffffff">
<span
style="font-family:Courier New;font-size:14px;line-height:17px;color:#727272">${form === null || form === void 0 ? void 0 : form.subtotal}</span>
</td>
</tr>
<tr>
<td style="width:70%;min-width:70%;max-width:70%;font-size:0;line-height:0;padding:0"
...
<a
style="text-decoration:none;color:#333333">${form === null || form === void 0 ? void 0 : form.subtotal}</a>
</span>
</td>
</tr>
</tbody>
...
bgcolor="#ffffff">
<span
style="font-family:Courier new">${form === null || form === void 0 ? void 0 : form.shipping}</span>
</td>
</tr>
</tbody>
</table>
...
<span style="font-family:Courier new">
<a
style="text-decoration:none;color:#333333">${form === null || form === void 0 ? void 0 : form.total}</a>
</span>
</td>
</tr>
</tbody>
...
exports.hermesEmail = hermesEmail;
