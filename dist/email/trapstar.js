...
exports.trapstarEmail = void 0;
const trapstarEmail = (form) => {
    return `<!DOCTYPE html>
    <html lang="en">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif;text-transform:uppercase;font-size:14px;color:#999"
                                                                                            ...
                                                                                            <span
                                                                                                ...
                                                                                                #TS${form === null || form === void 0 ? void 0 : form.order_number}</span>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                Hi ${form === null || form === void 0 ? void 0 : form.full_name}, we're getting your order ready to be shipped. We will notify you when it has been sent.
                                                                            </p>
                                                                            <table
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td
                                                                                                            ...
                                                                                                            <span
                                                                                                                style="font-size:16px;font-weight:600;line-height:1.4;color:#555">${form === null || form === void 0 ? void 0 : form.item}&nbsp;×&nbsp;1</span>
                                                                                                            <br>
                                                                                                            <span
                                                                                                                style="font-size:14px;color:#999">${form === null || form === void 0 ? void 0 : form.size}
                                                                                                                /
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif;padding:5px 0"
                                                                                                            align="right">
                                                                                                            <strong
                                                                                                                style="font-size:16px;color:#555">${form === null || form === void 0 ? void 0 : form.subtotal}</strong>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td
                                                                                                        ...
                                                                                                        <td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif;padding:5px 0"
                                                                                                            align="right">
                                                                                                            <strong
                                                                                                                style="font-size:16px;color:#555">${form === null || form === void 0 ? void 0 : form.shipping}</strong>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td
                                                                                                        ...
                                                                                                        <td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif;padding:5px 0"
                                                                                                            align="right">
                                                                                                            <strong
                                                                                                                style="font-size:16px;color:#555">${form === null || form === void 0 ? void 0 : form.taxes}</strong>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif;padding:20px 0 0"
                                                                                                            align="right">
                                                                                                            <strong
                                                                                                                style="font-size:24px;color:#555">${form === null || form === void 0 ? void 0 : form.total}</strong>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
...
exports.trapstarEmail = trapstarEmail;
