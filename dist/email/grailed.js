...
exports.grailedEmail = void 0;
const grailedEmail = (form) => {
    return `<!DOCTYPE html>
<html lang="en">
...
<strong>${form === null || form === void 0 ? void 0 : form.brand}</strong>
</p>
<p
...
<p
style="margin:0;font-size:14px;line-height:25px">
<strong>${form === null || form === void 0 ? void 0 : form.full_name}</strong>
</p>
<p
style="margin:0;font-size:14px;line-height:25px">
...
Your Seller is Located in: ${form === null || form === void 0 ? void 0 : form.seller_location}
</div>
...
title="packingthings"
src=${form === null || form === void 0 ? void 0 : form.seller_profile_image_link}
...
<tr>
<td>${form === null || form === void 0 ? void 0 : form.seller_location}</td>
<td style="width:50">
<strong>TO</strong>
</td>
<td>${form === null || form === void 0 ? void 0 : form.country}</td>
</tr>
</tbody>
</table>
</td>
...
exports.grailedEmail = grailedEmail;
